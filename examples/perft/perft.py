...
def main(perft_file, perft_f, max_depth, max_nodes):
    current_id = None
    board = shogi.Board()
    column = 0
    total_nodes = 0
    ...
    for line in perft_file:
        ...
        if cmd == "id":
            ...
            if nodes != perft_nodes:
                ...
                print(board)
                print()
                for move in sorted(board.legal_moves, key=lambda m: m.usi()):
                    board.push(move)
...
if __name__ == "__main__":
    ...
    for perft_file in args.perft:
        ...
        main(perft_file, perft_f, args.max_depth, args.max_nodes)
